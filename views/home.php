...
if(isset($_POST['find']))
{
    $data=new EmployesContoller();
    $employes=$data->findEmployee();
}else
{
    $data=new EmployesContoller();
        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="card">
                <div class="card-body bg-light">
                    ...
                    </a><a href="<?php echo BASE_URL?>logout" title="Déconnexion" class="btn btn-link  mr-2 mb-2">
